                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card board1 fill">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                <div>
                                    <h3 class="card_widget_header">{{ $totalStaffs }}</h3>
                ...
                <div class="col-md-12 d-flex">
                    <div class="card card-table flex-fill">
                        <div class="card-header">
                            ...
                            <a href="{{ route('bookings.index') }}" type="button" class="btn btn-primary float-right veiwbutton">Veiw All</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-hover table-center">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allBookings as $allBooking)
                                            ...
                                            <tr>
                                                <td>{{ $allBooking->id }}</td>
                                                <td>{{ $allBooking->personalName }}</td>
                                                <td>{{ $allBooking->email }}</td>
                                                <td  class="text-center">{{ $allBooking->rooms->roomType}}</td>
                                                <td class="text-center" >{{ $allBooking->roomNumber}}</td>
                                                <td>
                                                    @if ($allBooking->paied == 0)
                                                ...
                                                <td>
                                                    @if ($allBooking->Status == 0)
                                                        <p class="btn btn-danger">Inactine</p>
                                                    @else
