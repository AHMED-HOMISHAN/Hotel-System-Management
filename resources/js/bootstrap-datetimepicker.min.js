    ...
    var c = function (c, d) {
        var e,
                        ...
                        a("<tr>")
                            .append(
                                a("<th>")
                                    ...
                                    .append(
                                        a("<span>").addClass(d.icons.previous)
                                    )
                            )
                            .append(
                                a("<th>")
            ...
            I = function () {
                ...
                if (
                    ...
                    "right" === h
                        ? o.addClass("float-right")
                        : o.removeClass("float-right"),
            ...
            J = function (a) {
                ("dp.change" === a.type &&
                    ((a.date && a.date.isSame(a.oldDate)) ||
                        (!a.date && !a.oldDate))) ||
                    c.trigger(a);
            },
            K = function (a) {
            ...
            V = function () {
                ...
                for (
                    ...
                    (a = h.year() + 12),
                        (k =
                            d.minDate &&
                            d.minDate.isAfter(h, "y") &&
                            d.minDate.year() <= a),
                        (l =
                            d.maxDate &&
                            d.maxDate.isAfter(h, "y") &&
                            d.maxDate.year() <= a),
                        (m +=
            ...
            aa = function (a) {
                ...
                if (
                    ...
                    for (
                        a
                            .minutes(
                                Math.round(a.minutes() / d.stepping) *
                                    d.stepping
                            )
                            .seconds(0);
            ...
            fa = function (b) {
                return (
                    ...
                    (ea[a(b.currentTarget).data("action")].apply(l, arguments),
                    !1)
                );
            },
            ga = function () {
        ...
        if (
            ...
            (l.enabledDates = function (b) {
                if (0 === arguments.length)
                    return d.enabledDates
                        ? a.extend({}, d.enabledDates)
                        : d.enabledDates;
            ...
            (l.viewMode = function (a) {
                ...
                return (
                    (d.viewMode = a), (k = Math.max(r.indexOf(a), p)), L(), l
                );
            }),
            ...
            (l.showClear = function (a) {
                ...
                if ("boolean" != typeof a)
                    throw new TypeError(
                        "showClear() expects a boolean parameter"
                    );
            ...
            (l.showClose = function (a) {
                ...
                if ("boolean" != typeof a)
                    throw new TypeError(
                        "showClose() expects a boolean parameter"
                    );
            ...
            (l.parseInputDate = function (a) {
                ...
                if ("function" != typeof a)
                    throw new TypeError(
                        "parseInputDate() sholud be as function"
                    );
            ...
            (l.enabledHours = function (b) {
                if (0 === arguments.length)
                    return d.enabledHours
                        ? a.extend({}, d.enabledHours)
                        : d.enabledHours;
